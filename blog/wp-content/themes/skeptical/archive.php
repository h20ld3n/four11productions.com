...
<?php $sidebar = $woo_options['woo_sidebar']; ?>
    ...
    <div id="content" class="col-full">
		...
		<?php if (have_posts()) : $count = 0; ?>
            ...
            <?php if (is_category()) { ?>
        	<span class="archive_header"><span class="cat"><?php _e('Archive', 'woothemes'); ?> | <?php echo single_cat_title(); ?></span> <span class="fr catrss"><?php $cat_obj = $wp_query->get_queried_object(); $cat_id = $cat_obj->cat_ID; echo '<a href="'; get_category_rss_link(true, $cat, ''); echo '">'; _e("RSS for this section", "woothemes"); echo '</a>'; ?></span></span>        
