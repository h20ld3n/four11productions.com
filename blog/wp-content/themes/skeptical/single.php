            ...
            <?php while (have_posts()) : the_post(); $count++; ?>
            	...
            	<div class="post">
            		...
            		<div class="middle col-left">
            	    	...
            	    	<?php if ( $woo_options['woo_thumb_single'] == "true" ) woo_image('width=519&height='.$woo_options['woo_single_h'].'&class=thumbnail main-image '.$woo_options['woo_thumb_single_align']); ?> 
